...
This plugin allows you to pre-load all scripts and styles in the plugin settings, as well as inject custom JavaScript and code to suit your needs.

You have the option to choose whether a script should be automatically or manually uploaded in all posts. 
